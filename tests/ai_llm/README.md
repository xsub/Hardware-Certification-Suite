...
| `ai_llm_source_ref` | `master` | llama.cpp ref to build. |
...
directory. The result JSON records the backend, model, thread count, and the
prompt-processing and token-generation throughput for SIG review.
